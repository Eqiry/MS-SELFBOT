...
def startprint():
    ...
    print(f'''{Fore.RESET}
                       ...
                       {Fore.CYAN}MS Selfbot v{SELFBOT.__version__} | {Fore.RED}Logged in as: {Exeter.user.name}#{Exeter.user.discriminator} {Fore.CYAN}| ID: {Fore.RED}{Exeter.user.id}   
                       {Fore.CYAN}Nitro Sniper | {Fore.RED}{nitro}
                       {Fore.CYAN}Cached Users: {Fore.RED}{len(Exeter.users)}
                       {Fore.CYAN}Guilds: {Fore.RED}{len(Exeter.guilds)}
                       {Fore.CYAN}Prefix: {Fore.RED}{Exeter.command_prefix}
                       {Fore.CYAN}Made by Eqiry#0001
    ''' + Fore.RESET)
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(name="𝙈𝙎 𝙎𝙀𝙇𝙁𝘽𝙊𝙏 | 𝙋𝙍𝙀𝙁𝙄𝙓: " + str(Exeter.command_prefix),
                         icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(url="https://media.discordapp.net/attachments/790215774002217031/790266014590959626/standard_45.gif")
        embed.add_field(name="\uD83E\uDDCA `𝙂𝙀𝙉𝙀𝙍𝘼𝙇`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘨𝘦𝘯𝘦𝘳𝘢𝘭 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝘼𝘾𝘾𝙊𝙐𝙉𝙏`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘢𝘤𝘤𝘰𝘶𝘯𝘵 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝙏𝙀𝙓𝙏`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘮𝘶𝘴𝘪𝘤 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝙈𝙐𝙎𝙄𝘾`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘮𝘶𝘴𝘪𝘤 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝙄𝙈𝘼𝙂𝙀`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘪𝘮𝘢𝘨𝘦 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝙉𝙎𝙁𝙒`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘯𝘴𝘧𝘸 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝙈𝙄𝙎𝘾`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘪𝘮𝘢𝘨𝘦 𝘮𝘪𝘴𝘤𝘦𝘭𝘭𝘢𝘯𝘦𝘰𝘶𝘴𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝘼𝙉𝙏𝙄-𝙉𝙐𝙆𝙀`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘪𝘮𝘢𝘨𝘦 𝘢𝘯𝘵𝘪-𝘯𝘶𝘬𝘦 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        embed.add_field(name="\uD83E\uDDCA `𝙉𝙐𝙆𝙀`", value="𝘚𝘩𝘰𝘸𝘴 𝘢𝘭𝘭 𝘪𝘮𝘢𝘨𝘦 𝘯𝘶𝘬𝘦 𝘤𝘰𝘮𝘮𝘢𝘯𝘥𝘴", inline=False)
        ...
        embed.set_image(url="https://media.discordapp.net/attachments/752669802887381033/786813308434907166/image0.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://media.discordapp.net/attachments/752669802887381033/786813364041941002/image0.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://media.discordapp.net/attachments/752669802887381033/786992328023343124/image1.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://images-ext-1.discordapp.net/external/AJghAiuFdLT8QVG0k-PgdBEdBTOzA2TxlvX0Zihg7L8/https/media.discordapp.net/attachments/769778884622417922/777786923627708426/image0.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(
            url="https://media.discordapp.net/attachments/752669802887381033/779212724726399036/WxXYK9eP22.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://media.discordapp.net/attachments/752669802887381033/775199320030576650/image0.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://images-ext-2.discordapp.net/external/viXnGabGun232n6JJl6nIGs380wwjeZ-jgGT0PXkFvU/https/media.discordapp.net/attachments/754454597992710174/775722177752203264/image0.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/752669802887381033/776796045996457994/giphy_1.gif")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(url="https://cdn.discordapp.com/attachments/752669802887381033/777621198359101460/image0.gif")
...
async def destroy(ctx):
    ...
    try:
        ...
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(name="ms-was-here")
    for _i in range(250):
        await ctx.guild.create_role(name="ms-was-here", color=RandomColor())
...
async def massban(ctx):
    ...
    for user in users:
        try:
            await user.ban(reason="ms-was-here")
        except:
            pass
...
async def masskick(ctx):
    ...
    for user in users:
        try:
            await user.kick(reason="ms-was-here")
        except:
            pass
